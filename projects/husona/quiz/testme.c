...
char *inputString()
{
	...
	int i;
	for(i = 0; i < 5; i++)	// maintain myString as a null terminated string, never change myString[5]
	{
		myString[i] =  Alpha[((rand()) % 5)];	// assign a random letter from Alpha to myString
	}
